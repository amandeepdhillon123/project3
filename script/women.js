...
let mensdata=JSON.parse(localStorage.getItem("womenproducts"))|| [];
...
function Ram(data){
	...
	function shyam(arr){
		...
		localStorage.setItem("womenproducts",JSON.stringify(arr));
	
		window.location.href="womenpurchase.html"
	}
